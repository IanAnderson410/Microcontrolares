...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(float, float, float, float, float, float, float)>(52, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 53 }, { QMetaType::Float, 54 }, { QMetaType::Float, 55 }, { QMetaType::Float, 56 },
            { QMetaType::Float, 57 }, { QMetaType::Float, 58 }, { QMetaType::Float, 59 },
        }}),
        // Slot 'enviarFlConfig'
        QtMocHelpers::SlotData<void(float, quint16, quint16)>(60, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 61 }, { QMetaType::UShort, 62 }, { QMetaType::UShort, 63 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8, quint8, float)>(64, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 65 }, { QMetaType::UChar, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 },
            { QMetaType::Float, 59 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8, quint8)>(64, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Float, 65 }, { QMetaType::UChar, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8)>(64, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Float, 65 }, { QMetaType::UChar, 66 }, { QMetaType::UChar, 67 },
        }}),
        // Slot 'buildUnerV1'
        QtMocHelpers::SlotData<QByteArray(uint8_t, uint8_t, const QByteArray &)>(69, 2, QMC::AccessPrivate, QMetaType::QByteArray, {{
            { 0x80000000 | 26, 27 }, { 0x80000000 | 26, 70 }, { QMetaType::QByteArray, 28 },
        }}),
        // Slot 'unerCrc16Ccitt'
        QtMocHelpers::SlotData<uint16_t(const QByteArray &)>(71, 2, QMC::AccessPrivate, 0x80000000 | 72, {{
            { QMetaType::QByteArray, 73 },
        }}),
        // Slot 'isCriticalCommand'
        QtMocHelpers::SlotData<bool(uint8_t) const>(74, 2, QMC::AccessPrivate, QMetaType::Bool, {{
            { 0x80000000 | 26, 27 },
        }}),
        // Slot 'processUnerV1Datagram'
        QtMocHelpers::SlotData<void(const QByteArray &)>(75, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QByteArray, 73 },
        }}),
        // Slot 'processTcpUnerStream'
        QtMocHelpers::SlotData<void()>(76, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleUnerV1Packet'
        QtMocHelpers::SlotData<void(uint8_t, uint8_t, uint8_t, const QByteArray &)>(77, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 26, 27 }, { 0x80000000 | 26, 70 }, { 0x80000000 | 26, 78 }, { QMetaType::QByteArray, 79 },
        }}),
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 35: _t->enviarYawConfig((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[5])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[6])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[7]))); break;
        ...
        case 37: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[5]))); break;
        case 38: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[4]))); break;
        case 39: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3]))); break;
        case 40: { QByteArray _r = _t->buildUnerV1((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[3])));
            if (_a[0]) *reinterpret_cast<QByteArray*>(_a[0]) = std::move(_r); }  break;
        case 41: { uint16_t _r = _t->unerCrc16Ccitt((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1])));
            if (_a[0]) *reinterpret_cast<uint16_t*>(_a[0]) = std::move(_r); }  break;
        case 42: { bool _r = _t->isCriticalCommand((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 43: _t->processUnerV1Datagram((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 44: _t->processTcpUnerStream(); break;
        case 45: _t->handleUnerV1Packet((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[4]))); break;
        case 46: _t->processPendingAckRetry(); break;
        ...
        case 52: _t->on_Advanced_pushButton_clicked(); break;
        case 53: _t->on_Setpoint_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 54: _t->on_StartCalibratePushButton_clicked(); break;
        case 55: _t->on_StopCalibratePushButton_clicked(); break;
        case 56: _t->on_SP_yaw_pushButton_clicked(); break;
        case 57: _t->on_Kd_yaw_pushButton_clicked(); break;
        case 58: _t->on_Kp_yaw_pushButton_clicked(); break;
        case 59: _t->on_ChangeModeIddlePushButton_clicked(); break;
        case 60: _t->on_ChangeModeRCPushButton_clicked(); break;
        case 61: _t->on_ChangeModeFLPushButton_clicked(); break;
        case 62: _t->on_Setpoint_doubleSpinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 63: _t->on_Screen2PushButton_2_clicked(); break;
        case 64: _t->on_Setpoint_FL_doubleSpinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 65: _t->on_Setpoint_FL_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 66: _t->on_Ajust_RC_Setpoint_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 67: _t->on_Limite_error_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
