...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(float, float, float, float, float, float, float, quint16)>(52, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 53 }, { QMetaType::Float, 54 }, { QMetaType::Float, 55 }, { QMetaType::Float, 56 },
            { QMetaType::Float, 57 }, { QMetaType::Float, 58 }, { QMetaType::Float, 59 }, { QMetaType::UShort, 60 },
        }}),
        // Slot 'enviarFlConfig'
        QtMocHelpers::SlotData<void(float, quint16, quint16)>(61, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 62 }, { QMetaType::UShort, 63 }, { QMetaType::UShort, 64 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8, quint8, float, quint16)>(65, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Float, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 }, { QMetaType::UChar, 69 },
            { QMetaType::Float, 59 }, { QMetaType::UShort, 60 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8, quint8, float)>(65, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Float, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 }, { QMetaType::UChar, 69 },
            { QMetaType::Float, 59 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8, quint8)>(65, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Float, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 }, { QMetaType::UChar, 69 },
        }}),
        // Slot 'enviarTurnManeuver'
        QtMocHelpers::SlotData<void(float, quint8, quint8)>(65, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Float, 66 }, { QMetaType::UChar, 67 }, { QMetaType::UChar, 68 },
        }}),
        // Slot 'buildUnerV1'
        QtMocHelpers::SlotData<QByteArray(uint8_t, uint8_t, const QByteArray &)>(70, 2, QMC::AccessPrivate, QMetaType::QByteArray, {{
            { 0x80000000 | 26, 27 }, { 0x80000000 | 26, 71 }, { QMetaType::QByteArray, 28 },
        }}),
        // Slot 'unerCrc16Ccitt'
        QtMocHelpers::SlotData<uint16_t(const QByteArray &)>(72, 2, QMC::AccessPrivate, 0x80000000 | 73, {{
            { QMetaType::QByteArray, 74 },
        }}),
        // Slot 'isCriticalCommand'
        QtMocHelpers::SlotData<bool(uint8_t) const>(75, 2, QMC::AccessPrivate, QMetaType::Bool, {{
            { 0x80000000 | 26, 27 },
        }}),
        // Slot 'processUnerV1Datagram'
        QtMocHelpers::SlotData<void(const QByteArray &)>(76, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QByteArray, 74 },
        }}),
        // Slot 'processTcpUnerStream'
        QtMocHelpers::SlotData<void()>(77, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleUnerV1Packet'
        QtMocHelpers::SlotData<void(uint8_t, uint8_t, uint8_t, const QByteArray &)>(78, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 26, 27 }, { 0x80000000 | 26, 71 }, { 0x80000000 | 26, 79 }, { QMetaType::QByteArray, 80 },
        }}),
        ...
        QtMocHelpers::SlotData<QString() const>(84, 2, QMC::AccessPrivate, QMetaType::QString),
        // Slot 'updateAccelLogPreview'
        QtMocHelpers::SlotData<void()>(85, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'buildIrRightLogCsv'
        QtMocHelpers::SlotData<QString() const>(86, 2, QMC::AccessPrivate, QMetaType::QString),
        ...
        QtMocHelpers::SlotData<void(const QString &)>(105, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 96 },
        }}),
        ...
        QtMocHelpers::SlotData<void(const QString &)>(107, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 96 },
        }}),
        // Slot 'on_Setpoint_FL_spinBox_textChanged'
        QtMocHelpers::SlotData<void(const QString &)>(108, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 96 },
        }}),
        ...
        QtMocHelpers::SlotData<void(const QString &)>(110, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 96 },
        }}),
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 35: _t->enviarYawConfig((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[5])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[6])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[7])),(*reinterpret_cast<std::add_pointer_t<quint16>>(_a[8]))); break;
        ...
        case 37: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[5])),(*reinterpret_cast<std::add_pointer_t<quint16>>(_a[6]))); break;
        case 38: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[5]))); break;
        case 39: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[4]))); break;
        case 40: _t->enviarTurnManeuver((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<quint8>>(_a[3]))); break;
        case 41: { QByteArray _r = _t->buildUnerV1((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[3])));
            if (_a[0]) *reinterpret_cast<QByteArray*>(_a[0]) = std::move(_r); }  break;
        case 42: { uint16_t _r = _t->unerCrc16Ccitt((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1])));
            if (_a[0]) *reinterpret_cast<uint16_t*>(_a[0]) = std::move(_r); }  break;
        case 43: { bool _r = _t->isCriticalCommand((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 44: _t->processUnerV1Datagram((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 45: _t->processTcpUnerStream(); break;
        case 46: _t->handleUnerV1Packet((*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[4]))); break;
        case 47: _t->sendAccelRunawayConfig(); break;
        case 48: _t->updateAccelRunawayModeButton((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 49: { QString _r = _t->buildAccelLogCsv();
            if (_a[0]) *reinterpret_cast<QString*>(_a[0]) = std::move(_r); }  break;
        case 50: _t->updateAccelLogPreview(); break;
        case 51: { QString _r = _t->buildIrRightLogCsv();
            if (_a[0]) *reinterpret_cast<QString*>(_a[0]) = std::move(_r); }  break;
        case 52: _t->updateIrRightLogPreview(); break;
        case 53: _t->processPendingAckRetry(); break;
        case 54: _t->on_PID_Alpha_pushButton_clicked(); break;
        case 55: _t->on_Home_pushButton_clicked(); break;
        case 56: _t->on_Ejecucion_pushButton_clicked(); break;
        case 57: _t->on_ScreenCalibrar_pushbutton_clicked(); break;
        case 58: _t->on_SistemasDeControl_pushButton_clicked(); break;
        case 59: _t->on_Advanced_pushButton_clicked(); break;
        case 60: _t->on_Setpoint_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 61: _t->on_StartCalibratePushButton_clicked(); break;
        case 62: _t->on_StopCalibratePushButton_clicked(); break;
        case 63: _t->on_SP_yaw_pushButton_clicked(); break;
        case 64: _t->on_Kd_yaw_pushButton_clicked(); break;
        case 65: _t->on_Kp_yaw_pushButton_clicked(); break;
        case 66: _t->on_ChangeModeIddlePushButton_clicked(); break;
        case 67: _t->on_ChangeModeRCPushButton_clicked(); break;
        case 68: _t->on_ChangeModeFLPushButton_clicked(); break;
        case 69: _t->on_Setpoint_doubleSpinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 70: _t->on_Screen2PushButton_2_clicked(); break;
        case 71: _t->on_Setpoint_FL_doubleSpinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 72: _t->on_Setpoint_FL_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 73: _t->on_Ajust_RC_Setpoint_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 74: _t->on_Limite_error_spinBox_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 75: _t->on_accelAdaptiveLimitSpin_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 76: _t->on_accelLogStartButton_clicked(); break;
        default: ;
        }
    }
}
